...
shop_name= 'aldmond22'
base_url = f'https://shopee.co.id/{shop_name}'
...
#mind the directory below 'user-data-dir=C:\\Users\\username\\AppData\\Local\\Google\\Chrome\\User Data\\Default'
...
import csv
newFilePath = f'shopee_{shop_name}_item_list.csv'
